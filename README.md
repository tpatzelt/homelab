...
| **orca** | Orca ADE | `orca.dev.example.com` | Agent development environment, headless `orca serve` (+ docker-in-docker sidecar) |
| **djcc** | djcc | `djcc.dev.example.com` | Live DJ booth over the `musik/dj` crate, heard at `/stream.mp3` |
